...
class TestDLPEngine:
    ...
    def test_ssn_detection(self):
        ...
        test_cases = ["123-45-6789", "SSN: 123 45 6789", "My SSN is 123456789"]
...
class TestAuditLogger:
    ...
    def test_log_compliance_event(self):
        ...
        with patch.object(logger, "_write_log") as mock_write:
            logger.log_compliance_event(
                regulation="GDPR", event_type="data_access_request", user_id="user-789"
            )
    ...
    def test_audit_log_format(self):
        ...
        with patch.object(logger, "_write_log") as mock_write:
            logger.log_action(user_id="user-123", action="test_action")
